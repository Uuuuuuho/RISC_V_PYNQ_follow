...
proc create_hier_cell_tutorialProcessor { parentCell nameHier } {
  ...
  # Create instance: picorv32_tut_0, and set properties
  set picorv32_tut_0 [ create_bd_cell -type ip -vlnv cliffordwolf:ip:picorv32_tut:1.0 picorv32_tut_0 ]
  ...
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins S_AXI_MEM] [get_bd_intf_pins psBramController/S_AXI]
  connect_bd_intf_net -intf_net picorv32_tut_0_mem_axi [get_bd_intf_pins picorv32_tut_0/mem_axi] [get_bd_intf_pins riscvBramController/S_AXI]
  ...
  connect_bd_net -net aux_reset_in_0_1 [get_bd_pins riscv_resetn] [get_bd_pins riscvReset/aux_reset_in]
  connect_bd_net -net ext_reset_in_0_1 [get_bd_pins por_resetn] [get_bd_pins riscvReset/ext_reset_in]
  connect_bd_net -net picorv32_tut_0_trap [get_bd_pins irq] [get_bd_pins picorv32_tut_0/trap]
  connect_bd_net -net riscvReset_peripheral_aresetn [get_bd_pins picorv32_tut_0/resetn] [get_bd_pins riscvBramController/s_axi_aresetn] [get_bd_pins riscvReset/peripheral_aresetn]
  connect_bd_net -net s_axi_aclk_0_1 [get_bd_pins s_axi_aclk] [get_bd_pins psBramController/s_axi_aclk]
  connect_bd_net -net s_axi_aresetn_0_1 [get_bd_pins s_axi_aresetn] [get_bd_pins psBramController/s_axi_aresetn]
  connect_bd_net -net slowest_sync_clk_0_1 [get_bd_pins riscv_clk] [get_bd_pins picorv32_tut_0/clk] [get_bd_pins riscvBramController/s_axi_aclk] [get_bd_pins riscvReset/slowest_sync_clk]
...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S_AXI_MEM_1 [get_bd_intf_pins psAxiInterconnect/M02_AXI] [get_bd_intf_pins tutorialProcessor/S_AXI_MEM]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins psAxiInterconnect/S00_AXI]
  ...
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins porReset/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins tutorialProcessor/por_resetn]
  connect_bd_net -net processing_system7_0_GPIO_O [get_bd_pins processing_system7_0/GPIO_O] [get_bd_pins resetSlice/Din]
  connect_bd_net -net psInterruptController_irq [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins psInterruptController/irq]
  connect_bd_net -net resetSlice_Dout [get_bd_pins resetSlice/Dout] [get_bd_pins tutorialProcessor/riscv_resetn]
  connect_bd_net -net subprocessorClk_clk_out1 [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins subprocessorClk/clk_out1] [get_bd_pins tutorialProcessor/riscv_clk]
  connect_bd_net -net tutorialProcessor_irq [get_bd_pins irqConcat/In0] [get_bd_pins tutorialProcessor/irq]

  # Create address segments
  create_bd_addr_seg -range 0x00008000 -offset 0x40008000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs tutorialProcessor/psBramController/S_AXI/Mem0] SEG_psBramController_Mem0
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x00000000 [get_bd_addr_spaces tutorialProcessor/picorv32_tut_0/mem_axi] [get_bd_addr_segs tutorialProcessor/riscvBramController/S_AXI/Mem0] SEG_riscvBramController_Mem0
